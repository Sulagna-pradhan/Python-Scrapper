...
METADATA_FILE = str(DATA_DIR / "imgbb_metadata.json")
BASE_SAVE_FOLDER = str(DATA_DIR / "downloads")

if not API_ID or not API_HASH or not IMGBB_API_KEY:
    raise RuntimeError("API_ID, API_HASH and IMGBB_API_KEY must be set in environment")

client = TelegramClient(str(SESSIONS_DIR / "imgbb_upload"), API_ID, API_HASH)
